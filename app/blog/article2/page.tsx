export default function Article2() {
  return (
    ...
    >
      ...
      <p>エラーが出れば、そのエラーをAIに伝える。</p>

      <p>するとAIが「ここを修正してください」と教えてくれる。</p>

      <p>その通りに修正して、また動かしてみる。</p>

      <p>そんなことを繰り返しながら、少しずつアプリを形にしていった。</p>
      ...
      <p>今回の開発目的は、単純にWebアプリを完成させることだけではない。</p>
      ...
      <p>しかし、実際にカレンダーの予定を管理するために使ってみると、</p>

      <p>「なぜこの変数をuseStateで管理する必要があるのか？」</p>

      <p>という疑問が出てくる。</p>

      <p>そこからReactのstateについて少し調べてみる。</p>

      <p>TypeScriptも同じだった。</p>

      <p>最初から型の重要性を理解していたわけではない。</p>
      ...
      <p>「そもそもTypeScriptは何のために型を指定しているのか？」</p>

      <p>と考えるようになる。</p>

      <p>
        つまり、自分の場合は
        <strong>実際に使ってみて、後から理解していく。</strong>
      </p>
      ...
      <p>開発初期のアプリは非常にシンプルだった。</p>

      <p>カレンダーを表示して、日付を選択し、予定名と担当者を入力する。</p>
      ...
      <p>開発初期と現在を比較すると、かなり違うアプリになっている。</p>
      ...
      <p>個人的に大きかったのが、LocalStorageによるデータ保存だった。</p>

      <p>
        開発初期は、ブラウザを再読み込みすると登録した予定が消えてしまった。
      </p>

      <p>当然、このままでは実際には使いにくい。</p>

      <p>そこでAIに相談しながらLocalStorageを使った保存機能を追加した。</p>
      ...
      <p>もちろん、これはデータベースを使った本格的なデータ保存ではない。</p>
      ...
      <p>最初は、「なんでこんなことでエラーになるんだ？」と思った。</p>

      <p>しかし、エラーを修正していくうちに、</p>
      ...
      <p>開発初期は、GitやGitHubについてもほとんど意識していなかった。</p>

      <p>しかし、開発が進むにつれてコードの変更も増えてきた。</p>
      ...
      <p>というcommitを作成してGitHubへpushしている。</p>
      ...
      <p>最終的には、Vercelを利用してアプリをインターネット上に公開した。</p>
...
インターネット上に公開`}
      ...
      <p>途中ではTypeScriptのエラーも発生したが、一つずつ修正していった。</p>
...
✓ Finalizing page optimization`}
      ...
      <p>となり、ビルドを成功させることができた。</p>

      <p>そしてGitHubとVercelを連携し、無事に公開まで完了した。</p>
      ...
      <p>これは今回の開発の中でも、かなり大きな達成感があった。</p>
      ...
      <p>今回の開発を振り返ると、AIにはかなり頼った。</p>

      <p>自分一人では書けなかったコードもたくさんある。</p>

      <p>AIにコードを書いてもらい、エラーが出たらAIに修正方法を聞いた。</p>

      <p>
        正直、
        <strong>
          コードの意味を十分に理解しないまま先に進んだ部分もかなりある。
        </strong>
      </p>
      ...
      <p>といったことを、実際に自分が書いたコードを題材にして学んでいく。</p>
      ...
      <p>今回の開発で一番大切にしたいのはここかもしれない。</p>

      <p>
        AIを使えば、プログラミング初心者でもある程度動くアプリを作ることができる。
      </p>

      <p>これは今回、自分自身が実際に経験した。</p>
      ...
      <p>今回の開発でも、実際にエラーが発生するたびにそのことを感じた。</p>
      ...
      <p>という一連の流れを経験することができた。</p>

      <p>ただ、まだ「経験した」だけで、すべてを理解できているわけではない。</p>

      <p>そこで今後は、この開発工程を一つずつ振り返っていく。</p>
      ...
      <p>といったことを、実際に自分が作ったアプリを題材にして整理していく。</p>
      ...
      <p>時にはAIに言われるがままコードを書いた。</p>

      <p>コードの意味を十分に理解しないまま先に進んだこともある。</p>

      <p>それでも、とにかく一つのWebアプリを形にすることを優先した。</p>
      ...
      <p>そして、そこから何を学んでいくのか。</p>

      <p>その過程を、これからもこのブログに残していこうと思う。</p>
    </div>
  );
}
